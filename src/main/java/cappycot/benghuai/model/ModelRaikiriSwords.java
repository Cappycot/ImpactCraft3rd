...
public class ModelRaikiriSwords extends ModelBase {
	...
	public ModelRaikiriSwords() {
		...
		this.HandleTip = new ModelRenderer(this, 0, 0);
		...
		this.HandleUpper = new ModelRenderer(this, 0, 0);
		...
		this.HandleCoverHigh2 = new ModelRenderer(this, 0, 0);
